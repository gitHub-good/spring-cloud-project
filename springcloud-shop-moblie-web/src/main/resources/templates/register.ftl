	...
	<div class="layout">
		<div class="nl-content">
			...
			<h1 class="nl-login-title" id="custom_display_256">
				<span id="message_LOGIN_TITLE">微服务注册账户</span>
			</h1>
			...
			<div class="nl-frame-container">
				<div class="ng-form-area show-place" id="form-area">
					<form method="post" action="register" id="miniLogin" onsubmit="return MiniLogin.validateForm();">
						<div class="shake-area" id="shake_area" style="z-index: 30;">
							...
							<div class="enter-area" id="enter_user">
								<input type="text" class="enter-item first-enter-item"
									...
									placeholder="用户名称">
								<i class="placeholder hide" id="message_INPUT_IDENTITY">用户名称</i>
							...
							<div class="enter-area" id="enter_user">
								<input type="text" name="email"
									...
									placeholder="邮&nbsp;&nbsp;&nbsp;&nbsp;箱">
								<i class="placeholder hide" id="message_INPUT_IDENTITY">邮&nbsp;&nbsp;&nbsp;&nbsp;箱</i>
								<span class="error-tip">
									<em class="error-ico"></em>
									<span class="error-msg"></span>
								</span>
						...
						<div class="shake-area" id="shake_area" style="z-index: 30;">
							...
							<div class="enter-area" id="enter_user">
								<input type="text" name="phone"
									...
									id="miniLogin_username" name="phone" autocomplete="off"
									placeholder="手机号码">
								<i class="placeholder hide" id="message_INPUT_IDENTITY">手机号码</i>
								<span class="error-tip">
									<em class="error-ico"></em>
									<span class="error-msg"></span>
								</span>
