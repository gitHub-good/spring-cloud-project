...
<div class="layout">
    <div class="nl-content">
        ...
        <h1 class="nl-login-title" id="custom_display_256">
            <span id="message_LOGIN_TITLE">微服务登录</span>
        </h1>
        ...
        <div id="custom_display_2">
            <p class="nl-login-intro" id="message_LOGIN_LINKS">
                ...
                <a href="https://docs.spring.io/spring-boot/docs/2.0.6.RELEASE/reference/htmlsingle/" target="_blank">Spring
                    Boot</a>，
                <a href="https://cloud.spring.io/spring-cloud-static/Finchley.SR2/single/spring-cloud.html"
                   target="_blank">Spring Cloud</a>，
                <a href="http://www.mybatis.org/mybatis-3/zh/configuration.html" target="_blank">Mybatis</a>，
                        ...
                        <input type="text" class="enter-item code-enter-item"
                               ...
                               placeholder="验证码"> <img src="" class="code-img"
                                                       id="code_img"> <i class="placeholder hide"
                                                                         id="message_INPUT_CONFIRM">验证码</i> <span
                            class="error-tip"><em
                        ...
                        <div style="display: none">
                            <div class="ng-cookie-area" id="cookie_area">
                                <input type="hidden" id="auto"><em class="checkbox"
                                                                   id="checkbox_item"></em> <span
                                    id="message_AUTOLOGIN_TWOWEEKS">两周内自动登录</span>
                            </div>
                        </div>
